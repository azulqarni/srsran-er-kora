...
// uint32 slice_id = 9;
inline void UeMetrics::clear_slice_id() {
  slice_id_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 UeMetrics::_internal_slice_id() const {
  return slice_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 UeMetrics::slice_id() const {
  // @@protoc_insertion_point(field_get:UeMetrics.slice_id)
  return _internal_slice_id();
}
inline void UeMetrics::_internal_set_slice_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  slice_id_ = value;
}
inline void UeMetrics::set_slice_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_slice_id(value);
  // @@protoc_insertion_point(field_set:UeMetrics.slice_id)
}
