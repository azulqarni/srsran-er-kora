...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_metrics_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::UeMetrics, slice_id_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_metrics_2eproto = {
  false, false, descriptor_table_protodef_metrics_2eproto, "metrics.proto", 245,
...
UeMetrics::UeMetrics(const UeMetrics& from)
  ...
  ::memcpy(&rnti_, &from.rnti_,
    static_cast<size_t>(reinterpret_cast<char*>(&slice_id_) -
    reinterpret_cast<char*>(&rnti_)) + sizeof(slice_id_));
...
::PROTOBUF_NAMESPACE_ID::uint8* UeMetrics::_InternalSerialize(
  ...
  if (this->slice_id() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(9, this->_internal_slice_id(), target);
  }
